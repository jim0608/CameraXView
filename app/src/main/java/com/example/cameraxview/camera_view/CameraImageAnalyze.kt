...
import com.example.cameraxview.camera_view.NV21Utils
import com.example.cameraxview.camera_view.CameraCallback
    ...
    override fun analyze(image: ImageProxy) {
        ...
        try {
            ...
            if (width != 0 && height !=0 && analyzeBean.nv21 != null) {
                try {
                    analyzeBean.nv21 = clipNv21(analyzeBean.nv21!!, image.width, image.height)
                }catch (e:Exception){
