...
import com.example.cameraxview.camera_view.FaceCameraView
import com.example.cameraxview.camera_view.CameraIdFilter
import java.util.*
...
class FaceCameraHelper(
    ...
    fun bindToLifecycleAfterViewMeasured() {
        ...
        mImageAnalyzerBuilder!!.let {
            ...
            it.setTargetRotation(getDisplaySurfaceRotation())
        ...
        mPreview!!.targetRotation = getDisplaySurfaceRotation()
